...
<br>
      ...
      <section class="profile-section">
        <div class="profile-info">
          <div class="profile-picture">
            <img src="https://lh6.googleusercontent.com/v7AcEffBw3l-rrQhYpm68HwXwmBQbsgq7oSc4X23szUWx2YNeNfwhR69b55dIHUUqGrz-v9ujsovDTytjn_M1XkxCPDYLF3mxtOyt1SiQCwKxhJvReqecqCML0ckJmv-9LO7SEoL4wq-I2eMqEEOIcjR0-zmBbDELtiJRt_NmLesXM80zpkVgw=w1280" alt="Md. Mehedi Hasan" />
          </div>
          <div class="profile-details">
            <h2>Maria Rashid</h2>
            <p><strong>Role:</strong>Genaral Manager </p>
            <p><strong>Academy:</strong> Mehedi's IoT Academy</p>
            <p><strong>Email:</strong> maria@iot725.edu.bd</p>
            <p><strong>Teacher ID:</strong> TCH002</p>
            <a href="edit_profile.php" class="btn btn-primary edit-profile-btn"><i class="fas fa-edit"></i> Edit Profile</a>
          </div>
        </div>
      </section>
      ...
      <section class="profile-section">
        <div class="profile-info">
          <div class="profile-picture">
            <img src="https://scontent.fdac138-1.fna.fbcdn.net/v/t39.30808-6/480667163_1411333653161837_3176004583455450053_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeFgTbVtDLMwjL5_qJYFhdBNMVBAgCLTL3UxUECAItMvdbD5TORyIwVlKsd4hZazdJ1ZYCf4qiRGN2iN6aIEubWV&_nc_ohc=cK1bDHRL8VIQ7kNvwGRgmTD&_nc_oc=AdmO1TKbM4tJOpC_n4QqbBkevSbc9ae5x0FjvZYIAGobM2PXm0pwFJ4NjGLBU9KBXtw&_nc_zt=23&_nc_ht=scontent.fdac138-1.fna&_nc_gid=pV9Xh0001DmEalvjjYJcdg&oh=00_AfWSfCbSeYqz9I36uiinA5UgTIXDkbDUj0ptZdiDm_y2Kw&oe=68AA4B56" alt="Md. Mehedi Hasan" />
          </div>
          <div class="profile-details">
            <h2>Emon Shahriare</h2>
            <p><strong>Role:</strong> Human Resource</p>
            <p><strong>Academy:</strong> Mehedi's IoT Academy</p>
            <p><strong>Email:</strong> emon@iot725.edu.bd</p>
            <p><strong>Teacher ID:</strong> TCH003</p>
            <a href="edit_profile.php" class="btn btn-primary edit-profile-btn"><i class="fas fa-edit"></i> Edit Profile</a>
          </div>
        </div>
      </section>
...
<section class="profile-section">
        <div class="profile-info">
          <div class="profile-picture">
            <img src="https://scontent.fdac138-1.fna.fbcdn.net/v/t39.30808-6/472858241_1280653706391648_5326217726692299072_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeFuGoPfLFpv0s6nkbEM9s5362d3r4eIywzrZ3evh4jLDM5MqeQF1z-j-9XACkLOI6iwQXbH0R37HpwjcKn0MkYw&_nc_ohc=yTW8CrQRrYwQ7kNvwHXSQwF&_nc_oc=AdkQ184lSEdiSyS2YUOrZfB-5YKehhZdRdiswrClia9EB1XoiMLFxxhT_jKrp3DXI7c&_nc_zt=23&_nc_ht=scontent.fdac138-1.fna&_nc_gid=uIG5LxnMt2NA69iV_KNwBA&oh=00_AfX3pji0fSAZcRuJxRleaeVSndF5AGqYNs1wyu8TZFz5Sw&oe=68AA7922" alt="Md. Mehedi Hasan" />
          </div>
          <div class="profile-details">
            <h2>Farhan Rohman</h2>
            <p><strong>Role: IoT Supervisor </strong> </p>
            <p><strong>Academy:</strong> Mehedi's IoT Academy</p>
            <p><strong>Email:</strong> farhan@iot725.edu.bd</p>
            <p><strong>Teacher ID:</strong> TCH003</p>
            <a href="edit_profile.php" class="btn btn-primary edit-profile-btn"><i class="fas fa-edit"></i> Edit Profile</a>
          </div>
        </div>
